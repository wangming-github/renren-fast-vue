  ...
  <el-row :gutter="20">
    ...
    <el-col :span="18">
      ...
      <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" size="small"
        ...
        <el-table-column prop="attrId" header-align="center" align="center" label="id" width="100"
          fixed></el-table-column>
        <el-table-column prop="attrName" header-align="center" align="center" label="属性名" width="150"></el-table-column>
        ...
        <el-table-column prop="icon" header-align="center" align="center" label="图标" width="150"></el-table-column>
        <el-table-column prop="valueSelect" header-align="center" align="center" label="可选值" width="250">
          <template slot-scope="scope">
      ...
      <!-- 弹窗, 新增 / 修改 -->
      <add-or-update :type="attrtype" v-if="addOrUpdateVisible" ref="addOrUpdate"
